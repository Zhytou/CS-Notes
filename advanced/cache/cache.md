...
- [缓存 Cache](#缓存-cache)
  - [简介 Introduction](#简介-introduction)
    ...
    - [分类](#分类)
    - [术语](#术语)
  - [映射 Cache Mapping](#映射-cache-mapping)
  ...
  - [策略 Cache Replacement Policy](#策略-cache-replacement-policy)
    - [LRU](#lru)
  - [模式 Cache Pattern](#模式-cache-pattern)
...
![](../img/computer_architecture_cache_direct_mapping.png)
